...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full flex items-center justify-center overflow-hidden border-2 border-white/20 shadow-2xl"
    ...
    >
      ...
      {/* High-Quality WhatsApp SVG Path (Standard) */}
      <svg
        viewBox="0 0 24 24"
